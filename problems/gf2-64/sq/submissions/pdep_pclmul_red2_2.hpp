...
GNU_TARGET("pclmul") inline u64 sq(u64 a) { return spread_bits(u32(a)) ^ ((u8[]){0, 27, 90, 65})[a >> 62] ^ (u64)_mm_clmulepi64_si128(_mm_cvtsi64_si128(spread_bits(u32(a >> 32))), _mm_cvtsi64_si128(0b11011), 0)[0]; }
}
struct GF2_64Op {
