...
inline __m256i frob12_frob36(u64 a0, u64 a1) {
 __m256i vA= _mm256_set_epi64x(FROB36_BYTE[1][u8(a1 >> 8)], FROB36_BYTE[0][u8(a1)], FROB12_BYTE[1][u8(a0 >> 8)], FROB12_BYTE[0][u8(a0)]);
 __m256i vB= _mm256_set_epi64x(FROB36_BYTE[3][u8(a1 >> 24)], FROB36_BYTE[2][u8(a1 >> 16)], FROB12_BYTE[3][u8(a0 >> 24)], FROB12_BYTE[2][u8(a0 >> 16)]);
 __m256i vC= _mm256_set_epi64x(FROB36_BYTE[5][u8(a1 >> 40)], FROB36_BYTE[4][u8(a1 >> 32)], FROB12_BYTE[5][u8(a0 >> 40)], FROB12_BYTE[4][u8(a0 >> 32)]);
 __m256i vD= _mm256_set_epi64x(FROB36_BYTE[7][u8(a1 >> 56)], FROB36_BYTE[6][u8(a1 >> 48)], FROB12_BYTE[7][u8(a0 >> 56)], FROB12_BYTE[6][u8(a0 >> 48)]);
 __m256i y= _mm256_xor_si256(_mm256_xor_si256(vA, vB), _mm256_xor_si256(vC, vD));
 return _mm256_xor_si256(y, _mm256_srli_si256(y, 8));
}
u64 pow(u64 a, u64 e) {
 ...
 const u32 r0= r & 0xFFF, r1= (r >> 12) & 0xFFF, r2= (r >> 24) & 0xFFF, r3= (r >> 36) & 0xFFF;
 u64 A0= T[r0 >> 8], A1= T[r1 >> 8], A2= T[r2 >> 8], A3= T[r3 >> 8];
 tie(A0, A1)= unpack(mul2(frob4_2lane(A0, A1), _mm256_set_epi64x(0, T[(r1 >> 4) & 0xF], 0, T[(r0 >> 4) & 0xF])));
 tie(A2, A3)= unpack(mul2(frob4_2lane(A2, A3), _mm256_set_epi64x(0, T[(r3 >> 4) & 0xF], 0, T[(r2 >> 4) & 0xF])));
 tie(A0, A1)= unpack(mul2(frob4_2lane(A0, A1), _mm256_set_epi64x(0, T[r1 & 0xF], 0, T[r0 & 0xF])));
 tie(A2, A3)= unpack(mul2(frob4_2lane(A2, A3), _mm256_set_epi64x(0, T[r3 & 0xF], 0, T[r2 & 0xF])));
 // 結合: a^r = frob36(A3)·frob24(A2)·frob12(A1)·A0 (48 bit 目はあとで)
