...
// 窓 (_win32.hpp): 4 bit × 8 桁。T[0..15] の偶数冪を sq で作る (mul2 3 本 + sq 7 回)
//
...
#include "_win32.hpp"
namespace gf2_64_pow_subfield32_ratio_4bit_sq {
...
GNU_TARGET("pclmul,vpclmulqdq") u64 pow(u64 a, u64 e) {
 ...
 auto [w0, w1]= win32_4bit_sq(a, u32(r));          // w0 w1 = a^(r mod 2^32)
...
struct GF2_64Op {
 static vector<u64> run(const vector<u64>& as, const vector<u64>& es) {
  using gf2_64_pow_subfield32_ratio_4bit_sq::pow;
