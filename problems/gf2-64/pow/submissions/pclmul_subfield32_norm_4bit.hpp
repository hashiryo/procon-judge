...
// 窓 (_win32.hpp): 4 bit × 8 桁。T[0..15] の組み方は byte_window_6_5 と同じ (mul2 7 本)
//
// r は 2^32 も取り得るが、そのときだけ a^(2^32) = frob32(a) を後から掛ける。
//
// 必要な拡張: VPCLMULQDQ + AVX2 (Intel Ice Lake / AMD Zen3 以降)。
#pragma GCC optimize("O3,unroll-loops")
#include "_subfield32_norm.hpp"
#include "_win32.hpp"
namespace gf2_64_pow_subfield32_norm_4bit {
...
u64 pow(u64 a, u64 e) {
 ...
 auto [w0, w1]= win32_4bit(a, u32(r));          // w0 w1 = a^(r mod 2^32)
...
struct GF2_64Op {
 static vector<u64> run(const vector<u64>& as, const vector<u64>& es) {
  using gf2_64_pow_subfield32_norm_4bit::pow;
