...
inline __m256i frob16_4lane(u64 a0, u64 a1, u64 a2, u64 a3) {
 ...
 __m256i vF= _mm256_set_epi64x(FROB16_BYTE[5][u8(a3 >> 40)], FROB16_BYTE[5][u8(a2 >> 40)], FROB16_BYTE[5][u8(a1 >> 40)], FROB16_BYTE[5][u8(a0 >> 40)]);
 __m256i vG= _mm256_set_epi64x(FROB16_BYTE[6][u8(a3 >> 48)], FROB16_BYTE[6][u8(a2 >> 48)], FROB16_BYTE[6][u8(a1 >> 48)], FROB16_BYTE[6][u8(a0 >> 48)]);
 __m256i vH= _mm256_set_epi64x(FROB16_BYTE[7][u8(a3 >> 56)], FROB16_BYTE[7][u8(a2 >> 56)], FROB16_BYTE[7][u8(a1 >> 56)], FROB16_BYTE[7][u8(a0 >> 56)]);
...
u64 pow(u64 a, u64 e) {
 ...
 // frob32 * 1
 __m256i f32hh= frob32_4lane(T[(e >> 48) & 0xF], T[(e >> 56) & 0xF], T[(e >> 52) & 0xF], T[(e >> 60) & 0xF]);
 __m256i f32hl= frob32_4lane(T[(e >> 32) & 0xF], T[(e >> 40) & 0xF], T[(e >> 36) & 0xF], T[(e >> 44) & 0xF]);
 __m256i lh= _mm256_set_epi64x(T[(e >> 28) & 0xF], T[(e >> 20) & 0xF], T[(e >> 24) & 0xF], T[(e >> 16) & 0xF]);
 __m256i ll= _mm256_set_epi64x(T[(e >> 12) & 0xF], T[(e >> 4) & 0xF], T[(e >> 8) & 0xF], T[e & 0xF]);
 auto [A6, A7]= unpack(mul2<0x11>(f32hh, lh));
 auto [A4, A5]= unpack(mul2(f32hh, lh));
 __m256i A23= mul2<0x11>(f32hl, ll);
 __m256i A01= mul2(f32hl, ll);
 ...
 // frob16 * 1
 __m256i f4657= frob16_4lane(A4, A6, A5, A7);
 auto [A2, A3]= unpack(mul2<0x01>(f4657, A23));
 A01= mul2(f4657, A01);
