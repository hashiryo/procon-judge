...
// }
inline __m256i frob8_2lane(u64 a0, u64 a1) {
 __m128i v0= _mm_set_epi64x(FROB8_BYTE[0][u8(a1)], FROB8_BYTE[0][u8(a0)]);
 __m128i v1= _mm_set_epi64x(FROB8_BYTE[1][u8(a1 >> 8)], FROB8_BYTE[1][u8(a0 >> 8)]);
 __m128i v2= _mm_set_epi64x(FROB8_BYTE[2][u8(a1 >> 16)], FROB8_BYTE[2][u8(a0 >> 16)]);
 __m128i v3= _mm_set_epi64x(FROB8_BYTE[3][u8(a1 >> 24)], FROB8_BYTE[3][u8(a0 >> 24)]);
 __m128i v4= _mm_set_epi64x(FROB8_BYTE[4][u8(a1 >> 32)], FROB8_BYTE[4][u8(a0 >> 32)]);
 __m128i v5= _mm_set_epi64x(FROB8_BYTE[5][u8(a1 >> 40)], FROB8_BYTE[5][u8(a0 >> 40)]);
...
// }
inline __m256i frob16_2lane(u64 a0, u64 a1) {
 __m128i v0= _mm_set_epi64x(FROB16_BYTE[0][u8(a1)], FROB16_BYTE[0][u8(a0)]);
 __m128i v1= _mm_set_epi64x(FROB16_BYTE[1][u8(a1 >> 8)], FROB16_BYTE[1][u8(a0 >> 8)]);
 __m128i v2= _mm_set_epi64x(FROB16_BYTE[2][u8(a1 >> 16)], FROB16_BYTE[2][u8(a0 >> 16)]);
 __m128i v3= _mm_set_epi64x(FROB16_BYTE[3][u8(a1 >> 24)], FROB16_BYTE[3][u8(a0 >> 24)]);
 __m128i v4= _mm_set_epi64x(FROB16_BYTE[4][u8(a1 >> 32)], FROB16_BYTE[4][u8(a0 >> 32)]);
 __m128i v5= _mm_set_epi64x(FROB16_BYTE[5][u8(a1 >> 40)], FROB16_BYTE[5][u8(a0 >> 40)]);
...
// }
inline __m256i frob32_2lane(u64 a0, u64 a1) {
 __m128i v0= _mm_set_epi64x(FROB32_BYTE[0][u8(a1)], FROB32_BYTE[0][u8(a0)]);
 __m128i v1= _mm_set_epi64x(FROB32_BYTE[1][u8(a1 >> 8)], FROB32_BYTE[1][u8(a0 >> 8)]);
 __m128i v2= _mm_set_epi64x(FROB32_BYTE[2][u8(a1 >> 16)], FROB32_BYTE[2][u8(a0 >> 16)]);
 __m128i v3= _mm_set_epi64x(FROB32_BYTE[3][u8(a1 >> 24)], FROB32_BYTE[3][u8(a0 >> 24)]);
 __m128i v4= _mm_set_epi64x(FROB32_BYTE[4][u8(a1 >> 32)], FROB32_BYTE[4][u8(a0 >> 32)]);
 __m128i v5= _mm_set_epi64x(FROB32_BYTE[5][u8(a1 >> 40)], FROB32_BYTE[5][u8(a0 >> 40)]);
...
u64 pow(u64 a, u64 e) {
 ...
 // frob32 * 1
 auto [A6, A7]= unpack(mul2(frob32_2lane(T[(e >> 56) & 0xF], T[(e >> 60) & 0xF]), _mm256_set_epi64x(0, T[(e >> 28) & 0xF], 0, T[(e >> 24) & 0xF])));
 auto [A4, A5]= unpack(mul2(frob32_2lane(T[(e >> 48) & 0xF], T[(e >> 52) & 0xF]), _mm256_set_epi64x(0, T[(e >> 20) & 0xF], 0, T[(e >> 16) & 0xF])));
 __m256i A23= mul2(frob32_2lane(T[(e >> 40) & 0xF], T[(e >> 44) & 0xF]), _mm256_set_epi64x(0, T[(e >> 12) & 0xF], 0, T[(e >> 8) & 0xF]));
 __m256i A01= mul2(frob32_2lane(T[(e >> 32) & 0xF], T[(e >> 36) & 0xF]), _mm256_set_epi64x(0, T[(e >> 4) & 0xF], 0, T[e & 0xF]));
