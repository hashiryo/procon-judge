...
u64 pow(u64 a, u64 e) {
 ...
 u64 T[16]= {1, a};
 u64 B;
 __m256i T2B= mul2(_mm256_set1_epi64x(a), _mm256_set_epi64x(0, frob32(a), 0, a));
 tie(T[2], B)= unpack(T2B);
 // L2: T[3], T[4]
 ...
 tie(T[15], B)= unpack(mul2(_mm256_set_epi64x(0, frob16(B), 0, T[13]), T2B));
 ...
 // 結合: a^r = frob40(A5)·frob32(A4)·frob24(A3)·frob16(A2)·fro8(A1)·A0 (48 bit 目はあとで)
 auto [A4, A5]= unpack(mul2(frob4_2lane(T[(r >> 36) & 0xF], T[(r >> 44) & 0xF]), _mm256_set_epi64x(0, T[(r >> 40) & 0xF], 0, T[(r >> 32) & 0xF])));
 auto [A2, A3]= unpack(mul2(frob16_2lane(A4, A5), mul2(frob4_2lane(T[(r >> 20) & 0xF], T[(r >> 28) & 0xF]), _mm256_set_epi64x(0, T[(r >> 24) & 0xF], 0, T[(r >> 16) & 0xF]))));
 auto [A0, A1]= unpack(mul2(frob16_2lane(A2, A3), mul2(frob4_2lane(T[(r >> 4) & 0xF], T[(r >> 12) & 0xF]), _mm256_set_epi64x(0, T[(r >> 8) & 0xF], 0, T[r & 0xF]))));
