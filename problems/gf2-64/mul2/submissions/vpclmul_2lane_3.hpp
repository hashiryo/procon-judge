...
inline __m256i mul2(const __m256i& a_vec, const __m256i& b_vec) {
 ...
 return _mm256_xor_si256(_mm256_xor_si256(prod, _mm256_shuffle_epi8(RED256, _mm256_srli_epi64(h, 60))), _mm256_xor_si256(_mm256_xor_si256(h, _mm256_slli_epi64(h, 1)), _mm256_xor_si256(_mm256_slli_epi64(h, 3), _mm256_slli_epi64(h, 4))));
}
}
struct GF2_64Op {
