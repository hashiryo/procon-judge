...
inline __m256i frob3_frob4(u64 a0, u64 a1) {
 __m256i vA= _mm256_set_epi64x(FROB4_BYTE[1][u8(a1 >> 8)], FROB4_BYTE[0][u8(a1)], FROB3_BYTE[1][u8(a0 >> 8)], FROB3_BYTE[0][u8(a0)]);
 __m256i vB= _mm256_set_epi64x(FROB4_BYTE[3][u8(a1 >> 24)], FROB4_BYTE[2][u8(a1 >> 16)], FROB3_BYTE[3][u8(a0 >> 24)], FROB3_BYTE[2][u8(a0 >> 16)]);
 __m256i vC= _mm256_set_epi64x(FROB4_BYTE[5][u8(a1 >> 40)], FROB4_BYTE[4][u8(a1 >> 32)], FROB3_BYTE[5][u8(a0 >> 40)], FROB3_BYTE[4][u8(a0 >> 32)]);
 __m256i vD= _mm256_set_epi64x(FROB4_BYTE[7][u8(a1 >> 56)], FROB4_BYTE[6][u8(a1 >> 48)], FROB3_BYTE[7][u8(a0 >> 56)], FROB3_BYTE[6][u8(a0 >> 48)]);
...
u64 log_g(u64 x) {
 ...
 auto [T24, T48]= unpack(T24_48);
 auto [T72, T51]= unpack(mul2(T24_48, _mm256_set_epi64x(0, T3, 0, T48)));
