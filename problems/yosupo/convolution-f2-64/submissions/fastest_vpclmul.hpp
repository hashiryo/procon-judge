#pragma once
#include "../common.hpp"
// fastest_v2.hpp の Phase B / IFFT-twiddle で、 各 butterfly の 2 個の GNU_TARGET("pclmul") を
...
//
// 効果:
//   GNU_TARGET("pclmul") throughput が約 2 倍に。 hot path の per-iter 2 GNU_TARGET("pclmul") → 1 VPCLMULQDQ。
//
