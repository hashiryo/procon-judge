...
//
// 期待効果: q=1 level (= 全 mul の ~1/d ≈ 5%) で 4 GNU_TARGET("pclmul") → 2 VPCLMULQDQ。
// 全体 ~2.5% 改善見込み。
//
...
inline const __m256i RED256_DIF_R4V2L= GF2_64_M256_SETR_EPI8(0, 27, 45, 54, 90, 65, 119, 108, 0, 0, 0, 0, 0, 0, 0, 0, 0, 27, 45, 54, 90, 65, 119, 108, 0, 0, 0, 0, 0, 0, 0, 0);
GNU_TARGET("vpclmulqdq") inline __m256i clmul_reduce_pair(__m256i a_vec, __m256i b_vec) {
 ...
 __m256i red_vec= _mm256_shuffle_epi8(RED256_DIF_R4V2L, indices);
...
// 構造: (a, 0, b, 0)
GNU_TARGET("vpclmulqdq") inline __m256i pack_u_pair(u64 a, u64 b) { return _mm256_set_epi64x(0, b, 0, a); }
// =============================================================================
...
GNU_TARGET("vpclmulqdq") inline void btf_fft_radix4_q1_simd(u64* base, __m256i v_vec, __m256i u_pair_vec) {
...
GNU_TARGET("vpclmulqdq") inline void btf_ifft_radix4_q1_simd(u64* base, __m256i v_vec, __m256i u_pair_inv_vec) {
