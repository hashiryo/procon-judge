...
// 構造: (a, 0, b, 0)
inline __m256i pack_u_pair(u64 a, u64 b) { return _mm256_set_epi64x(0, b, 0, a); }
// =============================================================================
...
inline void btf_fft_radix4_q1_simd(u64* base, __m256i v_vec, __m256i u_pair_vec) {
...
inline void btf_ifft_radix4_q1_simd(u64* base, __m256i v_vec, __m256i u_pair_inv_vec) {
