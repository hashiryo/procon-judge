...
// =============================================================================
inline std::tuple<i64, i64, i64, i64> solve_one(i64 n, i64 x, i64 y) {
...
inline std::vector<std::tuple<i64, i64, i64, i64>> run(const std::vector<std::tuple<i64, i64, i64>>& queries) {
