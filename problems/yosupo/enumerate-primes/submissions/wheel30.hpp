...
constexpr u32 PERIOD = 30;
constexpr u32 COPRIME = 8;
constexpr std::array<u8, COPRIME> RES = {1, 7, 11, 13, 17, 19, 23, 29};
// gap[s] = next residue - current residue (cyclic)
// 1→7=6, 7→11=4, 11→13=2, 13→17=4, 17→19=2, 19→23=4, 23→29=6, 29→31=2
constexpr std::array<u8, COPRIME> GAP = {6, 4, 2, 4, 2, 4, 6, 2};
// state[r mod 30] = (state_idx of residue ≥ r), or undefined if r is not coprime
constexpr auto STATE_OF_R = []() {
