...
inline __m256i frob16_frob48(u64 a0, u64 a1) {
 __m256i vA= _mm256_set_epi64x(FROB48_BYTE[1][u8(a1 >> 8)], FROB48_BYTE[0][u8(a1)], FROB16_BYTE[1][u8(a0 >> 8)], FROB16_BYTE[0][u8(a0)]);
 __m256i vB= _mm256_set_epi64x(FROB48_BYTE[3][u8(a1 >> 24)], FROB48_BYTE[2][u8(a1 >> 16)], FROB16_BYTE[3][u8(a0 >> 24)], FROB16_BYTE[2][u8(a0 >> 16)]);
 __m256i vC= _mm256_set_epi64x(FROB48_BYTE[5][u8(a1 >> 40)], FROB48_BYTE[4][u8(a1 >> 32)], FROB16_BYTE[5][u8(a0 >> 40)], FROB16_BYTE[4][u8(a0 >> 32)]);
 __m256i vD= _mm256_set_epi64x(FROB48_BYTE[7][u8(a1 >> 56)], FROB48_BYTE[6][u8(a1 >> 48)], FROB16_BYTE[7][u8(a0 >> 56)], FROB16_BYTE[6][u8(a0 >> 48)]);
 __m256i y= _mm256_xor_si256(_mm256_xor_si256(vA, vB), _mm256_xor_si256(vC, vD));
 return _mm256_xor_si256(y, _mm256_srli_si256(y, 8));
}
...
GNU_TARGET("pclmul,vpclmulqdq") u64 pow(u64 a, u64 e) {
 ...
 for(int i= 2; i >= 0; --i) {
  tie(A0, A1)= unpack(mul2(frob4_2lane(A0, A1), _mm256_set_epi64x(0, T[(e1 >> (4 * i)) & 0xF], 0, T[(e0 >> (4 * i)) & 0xF])));
  tie(A2, A3)= unpack(mul2(frob4_2lane(A2, A3), _mm256_set_epi64x(0, T[(e3 >> (4 * i)) & 0xF], 0, T[(e2 >> (4 * i)) & 0xF])));
 }
 // 結合: a^e = frob48(A3)·frob32(A2)·frob16(A1)·A0
 tie(A0, A2)= unpack(mul2(_mm256_set_epi64x(0, frob32(A2), 0, A0), frob16_frob48(A1, A3)));
 return mul(A0, A2);
}
}  // namespace gf2_64_pow_byte_window_6_2
struct GF2_64Op {
