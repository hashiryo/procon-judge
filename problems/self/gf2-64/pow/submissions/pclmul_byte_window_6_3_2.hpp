...
inline __m256i frob16_frob48(u64 a0, u64 a1) {
 __m256i vA= _mm256_set_epi64x(0, FROB48_BYTE[0][u8(a1)], 0, FROB16_BYTE[0][u8(a0)]);
 for(int i= 1; i < 8; ++i)vA= _mm256_xor_si256(vA, _mm256_set_epi64x(0, FROB48_BYTE[i][u8(a1 >> (8 * i))], 0, FROB16_BYTE[i][u8(a0 >> (8 * i))]));
 return vA;
}
u64 pow(u64 a, u64 e) {
 if(e == 0) return 1;
