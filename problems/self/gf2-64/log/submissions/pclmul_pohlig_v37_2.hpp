#pragma once
// v37 (± 対称性 + baby step 半分) の 65537 の添字を、比を使う方に替えた版。
//
...
namespace gf2_64_log_pohlig_v37_2 {
...
struct GF2_64Op {
 static vector<u64> run(const vector<u64>& xs) {
  using gf2_64_log_pohlig_v37_2::init_tables;
  using gf2_64_log_pohlig_v37_2::log_g;
  init_tables();
